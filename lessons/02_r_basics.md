...
```
##   [1]  9.492249  9.224126  8.647251  8.408954 10.835291 11.262039  9.044931
##   [8] 10.348651  7.868382  9.322654 11.400277 10.770741 11.356613  7.908934
##  [15] 11.321941 10.017102 11.552450 10.813522 10.773820  8.660479  9.732441
##  [22]  7.849471  8.289526  9.633644 10.930325 10.578704  3.876897 12.828296
##  [29]  7.120815 11.669929  8.275465  5.555226 12.005522  8.409250 13.066259
##  [36]  8.071950  7.596090 11.034622  9.824797  9.143315 10.658923  8.552520
##  [43]  7.365055  9.780230 10.766072  7.395522 11.568309  6.582683 12.618981
##  [50]  8.801631  9.933838  7.583785 13.313585 13.526750 10.385822  7.629785
##  [57] 10.623628 10.484832  8.968591  6.695130  8.688320 13.587164 10.082131
##  [64] 11.122787 11.312572 13.285769 12.983654 11.320443  9.769705 13.974900
##  [71] 14.916998 10.632265  8.918167  7.763264 12.448399 11.878275 10.230503
##  [78] 12.974211  8.366927  9.549141  8.543075 11.451705 11.621992  7.068607
##  [85] 15.279795  5.686704  8.943200 10.654568 11.861393 12.232770 10.285228
##  [92]  7.107394  8.803727  8.065172  7.730798  9.111595 10.652852 12.411210
##  [99] 12.394886  8.364985
```
...
The `#` indicates a comment.  You can put whatever else you'd like after this, but on the same line as the `#`.  R will not evaluate it. Multiple `#####`, are still just seen as a comment.  When commenting your code, err on the side of too much!  Also, you will see `()`, `[]`, and `{}` used in R code.  The `()` indicates a function (almost always), the `[]` indicates indexing (grabbing values by the location), and the `{}` groups code that is meant to be run together and is usually used when programming functions in R.  Lastly is `%>%`.  This is the pipe and allows us to chain functions together.  It is used extensively in code from the Tidyverse.
